#!/bin/bash
#=============================================================================
# OpenRLHF-M MathV60K Training Script
#=============================================================================
# This script trains the Qwen2.5-VL-3B-Instruct model on the MathV60K dataset
# using Proximal Policy Optimization (PPO) with Ray for distributed training.
#
# The script:
...
# 4. Submits a PPO training job with the appropriate configuration
#
...
# Submit the PPO training job to Ray
echo "Starting training..."

# === GPU and Model Distribution Configuration ===
# Each model (ref, actor, critic) has access to all 4 GPUs
...
# --critic_num_nodes 1               : Number of nodes for critic model
# --critic_num_gpus_per_node 4       : All 4 GPUs allocated to critic model
...
# Using reinforce_baseline for advantage estimation
# --advantage_estimator reinforce_baseline : Method to estimate advantages
# --zero_stage 3                    : DeepSpeed ZeRO optimization level
# --bf16                            : Use bfloat16 precision
# --actor_learning_rate 4e-7        : Learning rate for actor model
# --init_kl_coef 0.0                : KL penalty coefficient
# --lambd 1                         : GAE lambda parameter
